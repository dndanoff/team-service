...
public class MemberRecord extends UpdatableRecordImpl<MemberRecord> implements Record6<Long, String, String, String, String, LocalDate> {

    private static final long serialVersionUID = -1680302893;
     ...
     */
    @Override
    public MemberRecord values(Long value1, String value2, String value3, String value4, String value5, LocalDate value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MemberRecord(Long id, String email, String firstName, String lastName, String photoUrl, LocalDate hireDate) {
        super(Member.MEMBER);
