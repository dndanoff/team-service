...
public class MemberRecord extends UpdatableRecordImpl<MemberRecord> implements Record7<Long, String, String, String, Long, LocalDate, Long> {

    private static final long serialVersionUID = -1919892151;
     ...
     */
    @Override
    public Row7<Long, String, String, String, Long, LocalDate, Long> fieldsRow() {
     ...
     */
    @Override
    public Row7<Long, String, String, String, Long, LocalDate, Long> valuesRow() {
     ...
     */
    @Override
    public MemberRecord values(Long value1, String value2, String value3, String value4, Long value5, LocalDate value6, Long value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MemberRecord(Long id, String firstName, String lastName, String photoUrl, Long titleId, LocalDate hireDate, Long teamId) {
        super(Member.MEMBER);
